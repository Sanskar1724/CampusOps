    ...
    <Shell>
      ...
      <div className="card max-w-lg space-y-3">
        ...
        <div className="flex gap-2">
          <button
            ...
            onClick={async () => {
              ...
              try {
                ...
                setMsg("A Google tab opened — press Allow there, wait for the “Gmail connected ✓” page, then press Refresh status below.");
              } catch (e: any) {
                setMsg(e.message);
              }
            }}
          ...
          <button className="btn-ghost" onClick={() => { refresh(); setMsg("Status refreshed."); }}>
            Refresh status
          </button>
        </div>
